...
const whyChooseData = [
  ...
  // },
  {
    ...
    description:
      "Complete guidance from Japanese language learning to university admission and student visa processing.",
    color: "from-red-500 to-red-600",
  },
  {
    id: 2,
    ...
    description:
      "Personalized support for JLPT preparation, scholarships, university admission, and visa guidance.",
    color: "from-orange-500 to-red-500",
  },
  {
    id: 3,
